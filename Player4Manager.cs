...
namespace Chute2
{
    class Player4Manager//pg 119, creating the player
    {
        public Sprite playerSprite;
        private float playerSpeed = 140.0f; //moves at 160 pixels per second 
            ...
            Vector2 screenBounds)
        {
            playerSprite = new Sprite(
                new Vector2((screenBounds.X - 64), 0),
                texture,
                initialFrame,
                Vector2.Zero);
            ...
            //Player 1 sprites
            walkingAnimationsheet = content.Load<Texture2D>(@"Textures\GoombaWalk");

            idleSheet = content.Load<Texture2D>(@"Textures\GoombaIdle");
        ...
        private void HandleInput(KeyboardState keyState, GamePadState gamePadState) //pg 121, handlekeyboardinput helper method
        {
            ...
            */
            ...
            if (((keyState.IsKeyDown(Keys.Space)) || gamePadState.Buttons.A == ButtonState.Pressed)
                && canJump == true)
            {
                AudioManager.Play4JumpEffect(pan);
        ...
        public void Update(GameTime gameTime)
        {
            ...
            HandleInput(Keyboard.GetState(), GamePad.GetState(PlayerIndex.Four));
