...
namespace Chute2 //pg 92, building the Sprite Class
{
    class Sprite
    {
        ...
        public int BoundingXPadding = 10;
        public int BoundingYPadding = 10;
        ...
        public void ChangeTexture(Texture2D sheet)
        {
            Texture = sheet;
        }
        ...
        public virtual void Draw(SpriteBatch spriteBatch, SpriteEffects flip)
        {
            spriteBatch.Draw(
                Texture,
                Center,
